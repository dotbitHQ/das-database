...
type TableRebateInfo struct {
	...
	InviteeAlgId     common.DasAlgorithmId    `json:"invitee_alg_id" gorm:"column:invitee_alg_id; type:smallint(6) NOT NULL DEFAULT '0' COMMENT '';"`
	InviteeSubAlgId  common.DasSubAlgorithmId `json:"invitee_sub_alg_id" gorm:"column:invitee_sub_alg_id; type:smallint(6) NOT NULL DEFAULT '0' COMMENT '';"`
	...
	InviterAlgId     common.DasAlgorithmId    `json:"inviter_alg_id" gorm:"column:inviter_alg_id; type:smallint(6) NOT NULL DEFAULT '0' COMMENT '';"`
	InviterSubAlgId  common.DasSubAlgorithmId `json:"inviter_sub_alg_id" gorm:"column:inviter_sub_alg_id; type:smallint(6) NOT NULL DEFAULT '0' COMMENT '';"`
